...
<Tab title="CVI">
## Changes
- Added a new recording requirement to [Replica Training](https://docs.tavus.io/sections/replicas/replica-training): Start the talking segment with a big smile.

## Enhancements
- Added [echo](https://docs.tavus.io/sections/event-schemas/conversation-echo) and [respond](https://docs.tavus.io/sections/event-schemas/conversation-respond) events to conversational context. 
