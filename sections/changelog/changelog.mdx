...
-  **Expanded tavus-llama context window:** Increased maximum context window to 120,000 tokens. For optimal performance and response times, we recommend staying under 100,000 tokens.
...
<Tab title="CVI">
## Changes
- Added a new recording requirement to <a href="https://docs.tavus.io/sections/replicas/replica-training" target="_blank">Replica Training</a>: Start the talking segment with a big smile.

## Enhancements
- Added <a href="https://docs.tavus.io/sections/event-schemas/conversation-echo" target="_blank">echo</a> and <a href="https://docs.tavus.io/sections/event-schemas/conversation-respond" target="_blank">respond</a> events to conversational context. 
