...
## Getting Started
You can create a personalized lip sync cvideo using the [Tavus Platform](https://platform.tavus.io/) or by following the steps in the [Lipsync API Quickstart Guide](/sections/lipsync/quickstart).
