...
description: |
    ...
    This is commonly used in combination with the <a href="/sections/event-schemas/conversation-interrupt" target="_blank" rel="noopener noreferrer">Interrupt Interaction</a>.
---