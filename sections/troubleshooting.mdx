...
<AccordionGroup>
  <Accordion title="Training Video Size">
    ...
    - **Success Rate**: Files over the recommended size may fail.
    - **Source Quality**: High resolution, frame rate, and audio quality are essential for high-quality replicas.
  ...
  <Accordion title="Consent Statement">
    ...
    - **Language**: We currently accept consent statements in **any** of our supported languages. You can see the <a href="/sections/conversational-video-interface/language-support" target='_blank'>supported languages here</a>.
