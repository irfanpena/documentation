...
- A script in either **text** format or a publicly accessible audio file (`.wav` or `.mp3`).
...
<Note>
You can also customize the video background to suit your needs. See the [**Background Customizations**](/link-to-article) article for more details.
</Note>
