...
<Note>
- Replace `<api_key>` with your actual API key. You can generate one by following the steps in the <a href="/sections/quickstart" target="_blank" rel="noopener noreferrer">Quickstart guide</a>.
