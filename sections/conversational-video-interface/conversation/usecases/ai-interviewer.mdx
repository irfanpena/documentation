...
* **System Prompt**: Provides detailed behavioral guidance to maintain a natural, spoken-word tone that is professional and supportive, structuring the interview flow clearly.  
* **Model Layers**:  
