...
* **System Prompt**: Provides rich behavioral guidance to ensure Bruce maintains the tone and presence of a trusted, enthusiastic sales mentor. He is highly engaging, naturally conversational, and never references being an AI. He initiates sessions with confident warmth and curiosity, focuses on the coachee’s unique challenges, and delivers personalized, story-rich feedback with a coach’s care and clarity.  
* **Model Layers**:  
  * **Perception Configuration**: Uses the Raven-0 perception model to observe nonverbal communication, such as eye contact, posture, and hand gestures. This enables the AI to give thoughtful, respectful feedback on how coachees present themselves during video-based sales interactions.  
