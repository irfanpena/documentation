...
* **System Prompt**: A detailed directive that governs the AI’s tone, behavior, and interaction style. It instructs Charlie to be spoken-word optimized, emotionally intelligent, witty, and personable, with sci-fi references and a relaxed tone.  
* **Model Layers**:  
