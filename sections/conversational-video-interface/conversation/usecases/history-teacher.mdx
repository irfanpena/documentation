...
<Note>
Note: Replace `<api_key>` with your actual API key. If you don't have one, follow the steps <a href="/sections/quickstart" target="_blank" rel="noopener noreferrer">here</a> to create one.
</Note>
