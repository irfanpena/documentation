...
## Getting Started
You can easily create a conversation by using the [Tavus Platform](https://platform.tavus.io/) or following the steps in the [Conversation API Quickstart](https://docs.google.com/document/d/1C4y9QTaM8SeWcgOV-xsUdRllQVqibsI8GERfO0UxD_o/edit?usp=sharing) guide.
