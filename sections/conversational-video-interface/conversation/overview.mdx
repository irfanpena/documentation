...
### What is Daily?
Tavus uses Daily as the integrated WebRTC provider. You do not need to create a Daily account, as the integration is handled for you. This allows you to build fully custom applications with CVI while accessing real-time audio and video streams as you would with WebRTC.
...
<CardGroup cols={3}>
  ...
  <Card title="Call Recording" icon="video" href="/sections/conversational-video-interface/conversation/customizations/recording">
