...
- **Language**: Set the conversation language. Use `multilingual` to enable ASR language detection that automatically identifies and responds in the user's spoken language.
   <Warning>
   If you're using a custom TTS voice, make sure it supports the selected language.
   </Warning>
...
## Getting Started
You can create a conversation or an audio-only conversation by using the [Tavus Platform](https://platform.tavus.io/) or following the steps in the [Conversation API Quickstart](https://docs.google.com/document/d/1C4y9QTaM8SeWcgOV-xsUdRllQVqibsI8GERfO0UxD_o/edit?usp=sharing) guide.
