...
<Step title="Step 4: Customize the Conversation UI Color">
...
For full control over the UI, you can use the [DailyCall's Properties](https://docs.daily.co/reference/daily-js/daily-call-client/properties) when creating DailyCall's frame.
...
<html>
  ...
  <body>
    <script>
      ...
      call.join({ url: 'https://tavus.daily.co/cd4c958171f504cb' });
    </script>
  </body>
</html>
```
