...
## Echo Mode
Tavus also supports an <a href="/sections/conversational-video-interface/echo-mode" taget="_blank">Echo mode</a> pipeline. It lets you send text or audio input directly to the persona for playback, bypassing most of the CVI pipeline.
<Warning>
