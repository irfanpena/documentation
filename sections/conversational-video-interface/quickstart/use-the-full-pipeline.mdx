...
Use the full pipeline to unlock the complete range of replica capabilities—including perception, speech recognition, and natural conversation flow.
...
<Warning>
It is not recommended to use [Echo Mode]() if you want the replica to have perception and speech recognition, as this mode skips those layers and limits natural interaction.
</Warning>