...
Your backend then will receive an event with properties `event_type = application.transcription_ready`.
</Accordion>
...
Your backend then will receive an event with properties `event_type = application.perception_analysis`.
</Accordion>
