...
1. Perception captures visual input.

2. STT transcribes user speech to text.

3. LLM processes the text and generates a response.

4. TTS converts the response to speech.

5. Realtime Replica renders digital human with synchronized voice and expression.

These layers work together in a live WebRTC conversation.
