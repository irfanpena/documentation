...
<CardGroup cols={2}>
    ...
    <Card title="Create a Persona" icon="user-gear" href="/sections/conversational-video-interface/persona/full-mode">
    Create your own customized persona.
    </Card>

    <Card title="Create a Replica" icon="clone" href="/sections/replica/quickstart">
    Create a personalized replica.
    </Card>

    <Card title="Custom LLM" icon="microchip" href="/sections/conversational-video-interface/persona/llm#custom-llms">
    Integrate your custom LLM.
    </Card>

    <Card title="Embed CVI into Your Site" icon="code" href="/sections/integrations/embedding-cvi">
