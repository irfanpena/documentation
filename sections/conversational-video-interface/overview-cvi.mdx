...
<AccordionGroup>
  ...
  <Accordion title="2. Perception" icon="eye">
    Uses <a href="/sections/conversational-video-interface/persona/perception" target="_blank">Raven</a> to analyze user expressions, gaze, background, and screen content. This visual context helps the replica understand and respond more naturally.
  </Accordion>
