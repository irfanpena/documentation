...
<Note> We offer a selection of optimized LLMs including **Llama 3.3 and OpenAI models** that are fully compatible with the `full` pipeline. This is our recommended mode for best results.</Note>
### Default Replica
...
## Getting Started
You can create a persona by using the [Tavus Platform](https://platform.tavus.io/) or following the steps in the [Persona API Quickstart](/sections/conversational-video-interface/persona/full-mode) guide.