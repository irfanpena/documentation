...
description: Tavus offers pre-built personas to help you get started quickly.
mode: wide
---
...
<Note>
To fetch all available stock personas, use the <a href="/reference/list-personas" target="_blank" rel="noopener noreferrer">List Personas endpoint</a>.
</Note>
