...
<Step title="Event Broadcast">  
   Tavus broadcasts a <a href="https://docs.tavus.io/sections/event-schemas/conversation-toolcall" target="_blank">tool call</a> event over the active <a href="https://docs.daily.co" target="_blank">Daily</a> room.
