...
**LLM tool calling** works with OpenAI’s [Function Calling](https://platform.openai.com/docs/guides/function-calling) and can be set up in the `llm` layer. It allows an AI agent to trigger functions based on user speech during a conversation.
<Note>
