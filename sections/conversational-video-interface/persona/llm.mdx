...
`tavus-llama` has a **hard limit of 128,000 tokens**. If this limit is exceeded, the conversation may crash.

To avoid this, we **recommend keeping input context within 120,000 tokens** as a safe threshold.

- 1 token = 4 characters on average.
- 128,000 tokens = 480,000 characters (including whitespace and punctuation).
