...
* All Tavus-hosted models have a **limit of 128,000 tokens**.
* To avoid crashes, keep input under the **recommended hard limit of 120,000 tokens**.
* Contexts over **100,000 tokens** may still work, but will experience noticeable performance degradation (Slow respond times).
