...
Echo Mode lets you send text or audio input for the persona to speak out loud. This mode is best suited when your application doesn’t require speech recognition or perception capabilities or if you already use a custom ASR/Perception pipeline.
<Note>
...
* `flask`
* [`daily-python`](https://docs.daily.co/reference/daily-python/installation)
...
1. Create a file named `script.py` and paste the following code:
