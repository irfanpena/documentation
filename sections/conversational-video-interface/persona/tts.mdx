...
<Note>
You can use any publicly accessible custom voice from ElevenLabs, Cartesia, or PlayHT without the provider's API key. If the voice is private, you still need to use the provider's API key
</Note>
