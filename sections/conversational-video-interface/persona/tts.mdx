...
<Note>
You can use any publicly accessible voice from ElevenLabs, Cartesia, or PlayHT without specifying your own API key. Just use the `layers.tts.external_voice_id` field with your Tavus API key. If the voice is private, you'll need to use a custodial API key for the respective provider.
</Note>
