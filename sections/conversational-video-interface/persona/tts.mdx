...
| `emotion`           | Array of `"emotion:level"` tags (e.g., `"positivity:high"`)             | –                                                                      |
...
<Note>
- [Cartesia Speed and Emotion Controls](https://docs.cartesia.ai/2024-11-13/build-with-cartesia/capability-guides/control-speed-and-emotion)  
