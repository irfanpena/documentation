...
<Note>
You can ask Tavus to add any public ElevenLabs voice to your account. Once added, you can use its `voice_id` without providing an API key. This is useful for dialect-specific voices like British English.
</Note>
