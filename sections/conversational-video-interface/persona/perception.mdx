...
<Note>
Please see <a href="/sections/conversational-video-interface/persona/perception-tool" target="_blank" rel="noopener noreferrer">Tool/Function Calling</a> for more details.
</Note>
