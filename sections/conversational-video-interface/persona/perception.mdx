...
<Note>
Please see [Tool/Function Calling](/sections/conversational-video-interface/persona/perception-tool) for more details.
</Note>
...
Below is an example of an end-of-call perception analysis payload for the [example persona](/sections/conversational-video-interface/persona/perception#example-use-case):
```json
{
  "properties": {
