...
**Perception tool calling** works with OpenAI’s [Function Calling](https://platform.openai.com/docs/guides/function-calling) and can be configured in the `perception` layer. It allows an AI agent to trigger functions based on visual cues during a conversation.
