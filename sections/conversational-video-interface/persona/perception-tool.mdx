...
<Step title="Event Broadcast"> 
   Tavus broadcasts a <a href="https://docs.tavus.io/sections/event-schemas/conversation-perception-tool-call" target="_blank">perception_tool_call</a> event over the active <a href="https://docs.daily.co" target="_blank">Daily</a> room.  
