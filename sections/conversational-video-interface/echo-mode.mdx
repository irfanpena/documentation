...
<Note>
Send text or base64 audio using the <a href="/sections/event-schemas/conversation-echo" target="_blank" rel="noopener noreferrer"><strong>Interactions Protocol</strong></a>.
</Note>
