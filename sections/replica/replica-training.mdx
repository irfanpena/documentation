...
description: Learn how to create the most accurate personal replica by submitting a high-quality training video.
---
...
| Record in landscape mode if using a phone | Turn your head away from the camera |
...
<Note>
This step is **only required for personal replicas**. If you’re creating an **AI replica** (not based on yourself), you can skip this video.
</Note>
...
<Frame>
<iframe src="https://drive.google.com/file/d/1n-rRuZop9F2sMRpOWWkE2lHcX-gHdHI7/preview" width="800" height="500" allow="autoplay"></iframe>
</Frame>
