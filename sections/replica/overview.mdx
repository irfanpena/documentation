...
You can create Replicas through the Tavus Developer Portal or via the Replica API. Refer to the [Replica API Quickstart Guide](/sections/replica/quickstart) to get started.
