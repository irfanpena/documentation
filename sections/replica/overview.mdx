...
A Replica is a hyper-realistic AI-generated video avatar created using Phoenix, Tavus's fully synthetic 3D-based model.

The Phoenix engine is a fully synthetic, 3D-based system built on Gaussian‑diffusion architecture. The latest version, Phoenix 3, enables full-face rendering with dynamic emotion control, capturing every microexpression, movement, and emotion in real time.
