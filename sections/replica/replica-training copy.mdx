...
After ensuring that your training video fits our quality requirements, submit your video through the [Developer Portal](https://platform.tavus.io/replicas/create) or through our <a href="/api-reference/phoenix-replica-model/create-replica" target="_blank" rel="noopener noreferrer">API endpoint</a>. 
