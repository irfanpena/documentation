...
<Note>
  To explore all available stock replicas, visit the <a href="https://platform.tavus.io/replicas" target="_blank">
  Replica Library</a>

   or use the <a href="/api-reference/phoenix-replica-model/get-replicas" target="_blank" rel="noopener noreferrer">
  List Replicas</a>
