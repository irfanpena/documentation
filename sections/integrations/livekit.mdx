...
<Warning>
If you haven't set up the app yet, follow the [LiveKit Voice AI quickstart](https://docs.livekit.io/agents/start/voice-ai/) first.
</Warning>

## Integration Guide

<Steps>
<Step title="Step 1: Configuration and Setup">
